...
if(isset($_SESSION["nombre"])){
    ...
    <div class="container"> 
        <h2>Crear Autor</h2>  
        <form method= "post" action="crearAutor.php" class="form-group">
        <label>Nombre:</label>
          <input type="text" class="form-control" name="nomAutor"/>
          <label>Apellido:</label>
          <input type="text" class="form-control" name="apAutor"/>
...
<!-- <?php 
              ...
              // ?>
              // <option value="<?php echo $datos["idAutor"];?>"> <?php echo $datos[ "nombre"]."".$datos["apellido"]; ?></option>     
              //   <?php
              // }
              // ?>s
    <!-- Popper and Boostrap -->
